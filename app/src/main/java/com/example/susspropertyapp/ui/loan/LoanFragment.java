package com.example.susspropertyapp.ui.loan;
...
public class LoanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(layout.fragment_loan, container, false);
        ...
        calculateMortgage();
        Button calculateBtn = root.findViewById(R.id.btnCalculate);
...
//                    Log.i("info", "reset clicked");
                ...
                case id.help:
                    NavHostFragment.findNavController(LoanFragment.this)
                            .navigate(id.action_navigation_loan_to_navigation_loan_help);
                    break;
                default:
                    break;
            }
